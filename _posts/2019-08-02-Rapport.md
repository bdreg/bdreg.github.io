...
Her kan du lese eller laste ned som *pdf* fil rapport for hvert sykehus som registrerer i BDR. Det kreves passord
for å ha tilgang til rapporten. Tar kontakt med BDR for å få passord for ditt sykehus.

OBS! Tryk knappen med *pdf* symbol nest sist på menyen for å laste ned pdf-fil.
